  ...
  return (
    <div className="TD_WRAPPER">
      <style>{`
        ...
        /* --- SECTION 2: CONTEXT --- */
        .TD_Context { padding: 100px 5%; background: #0f172a; color: #fff; text-align: center; }
        .TD_Context_H1 { font-size: 2.5rem; font-weight: 900; margin-bottom: 30px; color: #fff; text-transform: uppercase; }
        .TD_Context_P { max-width: 900px; margin: 0 auto; color: rgba(255,255,255,0.7); font-size: 1.1rem; line-height: 1.8; }
      ...
      <section className="TD_Flow">
        ...
        <div className="TD_Flow_Grid">
          {[
            ...
            >
              <div className="TD_Step_Num">PHASE {step.num}</div>
