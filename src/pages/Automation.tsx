  ...
  return (
    <div className="AU_WRAPPER">
      <style>{`
        ...
        .AU_Hero_Img { flex: 1; position: relative; }
        .AU_Hero_Img img { 
            width: 100%; 
            max-width: 550px; 
            border-radius: 40px; 
        ...
        /* --- SECTION 2: CONTEXT --- */
        .AU_Context { padding: 100px 5%; background: #0f172a; color: #fff; text-align: center; }
        .AU_Context_H1 { font-size: 2.5rem; font-weight: 900; margin-bottom: 30px; color: #fff; text-transform: uppercase; }
        .AU_Context_P { max-width: 900px; margin: 0 auto; color: rgba(255,255,255,0.7); font-size: 1.1rem; line-height: 1.8; }
        ...
        @media (max-width: 1024px) {
          .AU_Hero, .AU_Outcome { flex-direction: column; text-align: center; }
          .AU_Btn_Group { justify-content: center; }
        }
      `}</style>
